...
class AssoDashboardCauseController extends Controller
{
  ...
  public function index()
  {
    ...
    return view('asso.assodashboardCauses.index', compact('Causes'));
  }
  ...
  public function create()
  {
    ...
    return view('asso.assodashboardCauses.create', compact('Categores'));
  }
  ...
  public function store(Request $request)
  {
    ...
    return redirect()->TO('asso/assodashboardCauses')
  ...
  public function edit($slug)
  {
    ...
    $Categores = Category::all();
    return view('asso.assodashboardCauses.edit', compact('Cause', 'Categores'));
  }
