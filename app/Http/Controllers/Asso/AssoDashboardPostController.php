...
class AssoDashboardPostController extends Controller
{
     /**
    ...
    **/
    ...
    public function index()
    {
        ...
        return view('asso.assodashboardPosts.index',compact('Posts'));
    }
    /**
    ...
    public function create()
    {
        ...
        return view('asso.assodashboardPosts.create',compact('Users','Categores'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->file('image')){  
          ...
          $Post->save();
                ...
                return redirect()->TO('asso/assodashboardPosts')
    ...
    public function edit($slug)
    {
        ...
        // Categores
        $Categores = Category::all();
        return view('asso.assodashboardPosts.edit',compact('Post','Users','Categores'));
    }
