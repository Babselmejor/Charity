      ...
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title"><i class="icon-material-outline-assignment"></i> Crowdfunding
            <a href="{{ route('assodashboardCauses.create') }}" class="mb-2 btn btn-success mr-2">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td class="lo-stats__actions">
                          ...
                          <a href="{{ URL::to('asso/assodashboardCauses')}}/{{$Cause->slug}}/edit" class="mb-2 btn btn-sm btn-primary">
                          <i class="icon-feather-edit-2"></i> Edit</a>
                          <form action="{{ route('assodashboardCauses.destroy',$Cause->id) }}" method="POST" files="true" style="display: inline-block;">
                          @csrf
                          <!-- ================================ dashboard Causes  ========================================================================= -->
                          @method('DELETE')
              ...
              <div class="card-footer border-top">
                <div class="row">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Affichage de 10 {{ COUNT($Causes) }} sur {{ COUNT($Causes) }} Crowdfunding</a>
                    @else
