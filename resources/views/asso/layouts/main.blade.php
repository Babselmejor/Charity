        ...
        <div class="main-navbar">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              <li class="nav-item">
                <!-- ============================================= nav admin Site ============================================= -->
                <a class="nav-link active" href="{{ url('associations') }}">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="{{ url('asso/assodashboardPosts') }}">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="{{ url('asso/assodashboardCauses') }}">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="{{ url('asso/assodashboardEvents') }}">
                  <i class="icon-feather-file-text"></i>
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="{{ url('asso/assodashboardCategores') }}">
          ...
          <div class="main-navbar sticky-top bg-white">
            ...
            <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="{{ url('asso/assodashboardUsers') }}/{{ Auth::user()->name }}/edit">
                      <i class="icon-feather-edit"></i> Edit Profile</a>
                      <a class="dropdown-item" href="{{ url('asso/assodashboardSettings') }}">
