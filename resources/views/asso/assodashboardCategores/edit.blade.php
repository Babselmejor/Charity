    ...
    <div class="row">
      <div class="col-lg-9 col-md-12">
        ...
        <div class="card card-small mb-3">
          <div class="card-body">
            <form class="add-new-post" action="{{ route('assodashboardCategores.update',$Category->slug) }}" method="POST"  role="form" enctype="multipart/form-data">
            @csrf
            @method('PUT')
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex px-3">
                   <a href="{{ url('asso/assodashboardCategores') }}" class="btn btn-sm btn-outline-accent"><i class="icon-line-awesome-align-justify"></i> Categories</a>
