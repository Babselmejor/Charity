            ...
            <li class="list-group-item p-3">
              <div class="row">
                <div class="col">
                  ...
                  <form action="{{ route('assodashboardUsers.update',$User->name) }}" method="POST"  role="form" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    {{ method_field('patch') }}
                    <div class="form-row">
                      <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                          <label for="feInputState">Roles</label>
                          <input type="text" id="feInputState" class="form-control" name="role_id" value="{{ isset($User->role->display_name) ? $User->role->display_name : 'NO Role' }}" readonly>
                        </div>
                      </div> 
                      <!-- ============================================= links Content Start User ============================================= -->
                      <div class="form-row">
