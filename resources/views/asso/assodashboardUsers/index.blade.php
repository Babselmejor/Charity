    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class=" icon-feather-user-plus"></i> Utilisateurs
          <a href="{{ route('assodashboardUsers.create') }}" class="mb-2 btn btn-success mr-2">
              ...
              <div class="container-fluid px-0">
                <table class="table mb-0">
                  ...
                  <tbody>
                    ...
                    <a href="{{ URL::to('asso/assodashboardUsers')}}/{{$User->name}}/edit" class="mb-2 btn btn-sm btn-primary"><i class="icon-feather-edit-2"></i> Edit</a>
                          <form action="{{ route('assodashboardUsers.destroy',$User->id) }}" method="POST" files="true" style="display: inline-block;">
                            @csrf
                            @method('DELETE')
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col text-right view-report">
                    <!-- ============================================= links Content Start User ============================================= -->
                    @if(COUNT($Users) != NULL)
                    <a>Affichage de 10 à {{ COUNT($Users) }} sur {{ COUNT($Users) }} Utilisateurs</a>
                    @else
