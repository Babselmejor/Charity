      ...
      <div class="page-header row no-gutters py-4">
        <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
          ...
          <h3 class="page-title"><i class=" icon-line-awesome-tags"></i> Crowdsourcing
            <a href="{{ route('assodashboardEvents.create') }}" class="mb-2 btn btn-success mr-2">
                      ...
                      <tr>
                        ...
                        <td class="lo-stats__actions">
                          <div class="btn-group d-table ml-auto" role="group" aria-label="Basic example">
                            <!-- ====================== links Events Content Start =============================================== -->
                            <a href="{{ URL::to('asso/assodashboardEvents')}}/{{$Event->slug}}/edit" class="mb-2 btn btn-sm btn-primary">
                            <i class="icon-feather-edit-2"></i> Edit</a>
                            <form action="{{ route('assodashboardEvents.destroy',$Event->id) }}" method="POST" files="true" style="display: inline-block;">
                            @csrf
                            <!-- ====================== links Events Content Start =============================================== -->
                            @method('DELETE')
              ...
              <div class="card-footer border-top">
                <div class="row">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Affichage de 10 à {{ COUNT($Events) }} sur {{ COUNT($Events) }} Crowdsourcing</a>
                    @else
