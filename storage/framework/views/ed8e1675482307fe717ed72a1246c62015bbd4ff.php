  ...
  <div class="main-content-container container-fluid px-4">
    ...
    <div class="page-header row no-gutters py-4">
      <div class="col-12 col-sm-4 text-center text-sm-left mb-0">
        ...
        <h3 class="page-title"><i class="icon-line-awesome-align-justify"></i> Categories 
          <a href="<?php echo e(route('assodashboardCategores.create')); ?>" class="mb-2 btn btn-success mr-2"><i class="icon-material-outline-add-circle-outline"></i> 
          Add Categores</a>
        </h3>  
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12 mb-4">
          <div class="card card-small lo-stats h-100">
            ...
            <a href="<?php echo e(URL::to('asso/assodashboardCategores')); ?>/<?php echo e($Category->slug); ?>/edit" class="mb-2 btn btn-sm btn-primary">
            <i class="icon-feather-edit"></i> Edit</a>
           <!-- ================================ dashboard Categores store ====================================== -->
           <form action="<?php echo e(route('assodashboardCategores.destroy',$Category->id)); ?>" method="POST" files="true" style="display: inline-block;">
                            <?php echo csrf_field(); ?>
              ...
              <div class="row">
               <div class="col">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Affichage de 10 à <?php echo e(COUNT($Categores)); ?> sur <?php echo e(COUNT($Categores)); ?> Categories</a>
                    <?php else: ?>
                    <a>Affichage de 10 à 0 sur 0 catégories</a>
                    <?php endif; ?>
                  </div>
              </div>
            </div>
...
<?php echo $__env->make('asso.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views/asso/assodashboardCategores/index.blade.php ENDPATH**/ ?>