        ...
        <div class='card card-small mb-3'>
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <a class="btn btn-sm btn-outline-accent" href="<?php echo e(route('dashboardEvents.index')); ?>"><i class="icon-line-awesome-tags"></i> Crowdsourcing</a>
...
<?php echo $__env->make('asso.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views\asso\dashboardEvents\create.blade.php ENDPATH**/ ?>