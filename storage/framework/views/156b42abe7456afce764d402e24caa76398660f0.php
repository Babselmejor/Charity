            ...
            <li class="list-group-item p-3">
              <div class="row">
                <div class="col">
                  ...
                  <form action="<?php echo e(route('assodashboardUsers.update',$User->name)); ?>" method="POST"  role="form" enctype="multipart/form-data" class="form-horizontal">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('asso.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views/asso/assodashboardUsers/edit.blade.php ENDPATH**/ ?>