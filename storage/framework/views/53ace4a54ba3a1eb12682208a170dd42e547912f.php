      ...
      <div class="col-lg-9 col-md-12">
        ...
        <div class="card card-small mb-3">
          <div class="card-body">
              ...
              <form action="<?php echo e(route('assodashboardCategores.store')); ?>" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post">
              <?php echo csrf_field(); ?>
              <!-- ================================ dashboard Categores store ====================================== -->
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item d-flex px-3">
                   <a href="<?php echo e(url('asso/assodashboardCategores')); ?>" class="btn btn-sm btn-outline-accent"><i class="icon-line-awesome-align-justify"></i> Categories</a>
...
<?php echo $__env->make('asso.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views/asso/assodashboardCategores/create.blade.php ENDPATH**/ ?>