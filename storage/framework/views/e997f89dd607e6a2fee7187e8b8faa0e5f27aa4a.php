...
<head>
  ...
  <!-- ============================================= styles SiteTitle ============================================= -->
  <style>
    .main-sidebar, .main-navbar, .main-footer {
      background-color: #cff0ff; /* Light blue background */
    }
    
    .navbar-brand img {
      border-radius: 20px; /* Keep the rounded effect for the logo */
    }
  </style>
</head>
<body class="h-100">      
  <div class="container-fluid">
    <div class="row">
        ...
        <div class="main-navbar">
          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              <li class="nav-item">
                <!-- ============================================= nav admin Site ============================================= -->
                <a class="nav-link active" href="<?php echo e(url('associations')); ?>">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/assodashboardPosts')); ?>">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/assodashboardCauses')); ?>">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/assodashboardEvents')); ?>">
                  <i class="icon-feather-file-text"></i>
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/assodashboardCategores')); ?>">
          ...
          <div class="main-navbar sticky-top bg-white">
            ...
            <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="<?php echo e(url('asso/assodashboardUsers')); ?>/<?php echo e(Auth::user()->name); ?>/edit">
                      <i class="icon-feather-edit"></i> Edit Profile</a>
                      <a class="dropdown-item" href="<?php echo e(url('asso/assodashboardSettings')); ?>">
      ...
      </html><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views/asso/layouts/main.blade.php ENDPATH**/ ?>