              ...
              <div class="container-fluid px-0">
                <table class="table mb-0">
                  ...
                  <tbody>
                    ...
                    <a href="<?php echo e(URL::to('asso/dashboardUsers')); ?>/<?php echo e($User->name); ?>/edit" class="mb-2 btn btn-sm btn-primary"><i class="icon-feather-edit-2"></i> Edit</a>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col text-right view-report">
                    ...
                    <a>Affichage de 10 à <?php echo e(COUNT($Users)); ?> sur <?php echo e(COUNT($Users)); ?> Utilisateurs</a>
                    <?php else: ?>
                    <a>Affichage de 10 à 0 sur 0 utilisateurs</a>
                    <?php endif; ?>
                    <!-- ============================================= links Content Start User ============================================= -->
                  </div>
              </div>
...
<?php echo $__env->make('asso.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views\asso\dashboardUsers\index.blade.php ENDPATH**/ ?>