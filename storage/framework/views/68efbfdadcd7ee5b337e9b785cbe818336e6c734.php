          ...
          <div class="nav-wrapper">
            <ul class="nav flex-column">
              <li class="nav-item">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/dashboardPosts')); ?>">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/dashboardCauses')); ?>">
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/dashboardEvents')); ?>">
                  <i class="icon-feather-file-text"></i>
               ...
               <!-- ============================================= nav admin Site ============================================= -->
              <li class="nav-item">
                <a class="nav-link " href="<?php echo e(url('asso/dashboardCategores')); ?>">
          ...
          <div class="main-navbar sticky-top bg-white">
            ...
            <nav class="navbar d-flex justify-content-end navbar-light flex-md-nowrap p-0">
                ...
                <div class="dropdown-menu dropdown-menu-small">
                    <a class="dropdown-item" href="<?php echo e(url('asso/dashboardUsers')); ?>/<?php echo e(Auth::user()->name); ?>/edit">
                      <i class="icon-feather-edit"></i> Edit Profile</a>
                      <a class="dropdown-item" href="<?php echo e(url('asso/dashboardSettings')); ?>">
