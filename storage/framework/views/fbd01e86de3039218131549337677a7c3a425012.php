    ...
    <div class="col-lg-9 col-md-12">
      ...
      <div class="card card-small mb-3">
        <div id="form-container" class="card-body">
          <!-- ================================ links Events Content Start ========================================================================= -->
          <form action="<?php echo e(route('assodashboardEvents.store')); ?>" method="POST"  role="form" enctype="multipart/form-data" class="add-new-post">
            <?php echo csrf_field(); ?>
            <!-- ================================ links Events Content Start ========================================================================= -->
        ...
        <div class='card card-small mb-3'>
          ...
          <div class='card-body p-0'>
            <ul class="list-group list-group-flush">
              ...
              <a class="btn btn-sm btn-outline-accent" href="<?php echo e(route('assodashboardEvents.index')); ?>"><i class="icon-line-awesome-tags"></i> Crowdsourcing</a>
...
<?php echo $__env->make('asso.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\babs\Desktop\Charity\resources\views/asso/assodashboardEvents/create.blade.php ENDPATH**/ ?>